...
for index, curve in enumerate(curves):
	...
	u,v,w = curve[0]
	a,b,c = curve[3]
	curveData.bevel_depth = math.sqrt(math.pow((u - a), 2) + math.pow((v - b), 2) + math.pow((w - c), 2)) * 0.1
...
# create mesh copies of each curve and run a simple raytrace for intersecting faces, add a factor for error see url for the concept
#https://blender.stackexchange.com/questions/9073/how-to-check-if-two-meshes-intersect-in-python
# the trick is going to be getting the wireframe to maybe do the work for us rather than making the meshes
