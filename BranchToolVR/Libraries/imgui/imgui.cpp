...
ImGuiStyle::ImGuiStyle()
{
    ...
    Colors[ImGuiCol_WindowBg]               = ImVec4(0.05f, 0.07f, 0.14f, 0.94f);
    ...
    Colors[ImGuiCol_TitleBg]                = ImVec4(0.32f, 0.47f, 0.71f, 1.00f);
    Colors[ImGuiCol_TitleBgCollapsed]       = ImVec4(0.32f, 0.47f, 0.71f, 1.00f);
    Colors[ImGuiCol_TitleBgActive]          = ImVec4(0.32f, 0.47f, 0.71f, 1.00f);
    ...
    Colors[ImGuiCol_CloseButton]            = ImVec4(1.00f, 0.50f, 0.50f, 0.80f);
    Colors[ImGuiCol_CloseButtonHovered]     = ImVec4(1.00f, 0.50f, 0.50f, 0.90f);
    Colors[ImGuiCol_CloseButtonActive]      = ImVec4(1.00f, 0.50f, 0.30f, 1.00f);
